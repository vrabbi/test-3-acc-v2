...
```json
{
  ...
  "bsGitRepository" : "github.com?owner=vrabbi&repo=test-3-acc-v2",
  "owner" : "platform-team",
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->test-3-acc-v2]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=vrabbi&repo=test-3-acc-v2'
